...
[![arXiv](https://img.shields.io/badge/arXiv-Paper-brightgreen?logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.12351)
[![Project Page](https://img.shields.io/badge/project-Page-blue)](https://chloeqxq.github.io/LongNav_ProjectPage/)

This repository contains the official implementation of

**[LongNav-R1: Horizon-Adaptive Multi-Turn RL for Long-Horizon VLA Navigation](https://arxiv.org/abs/2602.12351)**

[Yue Hu](https://phyllish.github.io/), Avery Xi, [Qixin Xiao](https://scholar.google.com/citations?hl=en&user=lqyNeO4AAAAJ), [Seth Isaacson](https://sethisaacson.me/), [Henry X. Liu](https://traffic.engin.umich.edu/), [Ram Vasudevan](https://www.roahmlab.com/ram-personal), [Maani Ghaffari](https://curly.engin.umich.edu/)
...
```
### 3. HM3D ObjectNav Dataset Setup
Apply for [HM3D access](https://aihabitat.org/datasets/hm3d/) to get an api token id and secret. Then run [data_scripts/setup_dataset.sh](data_scripts/setup_dataset.sh) to download the dataset and setup the folder structure.
